...
private func mockReadMore() -> [LearnStrategyItem] {
    return [
        .header(
            localID: UUID().uuidString,
            title: .qotLearnHeaderTitle(string: "Read More"),
            subtitle: .qotLearnHeaderSubtitle(string: "34 Articles")
        ),

        .article(
            localID: UUID().uuidString,
            title: .qotLearnArticleTitle(string: "Leverage Stress Benefits"),
            subtitle: .qotLearnArticleSubtitle(string: "5 Min to read")
        ),

        .article(
            localID: UUID().uuidString,
            title: .qotLearnArticleTitle(string: "Off to see the wizard"),
            subtitle: .qotLearnArticleSubtitle(string: "5:45 to listen")
        ),

        .article(
            localID: UUID().uuidString,
            title: .qotLearnArticleTitle(string: "The small change that do"),
            subtitle: .qotLearnArticleSubtitle(string: "4 min read")
        )
    ]
}
