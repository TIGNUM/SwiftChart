...
final class LearnStrategyViewModel {
    ...
    func item(at index: Index) -> LearnStrategyItem? {
        return nil
    }
}
...
enum LearnStrategyItem {
    ...
    case readMoreItems(localID: String, title: String, subtitle: String, items: [LearnStrategyReadMoreItem])
}
...
private func mockLearnStrategyItems() -> [LearnStrategyItem] {
    return [
        ...
        .readMoreItems(localID: UUID().uuidString, title: "", subtitle: "", items: mockReadMoreItems())
    ]
}

private func mockReadMoreItems() -> [LearnStrategyReadMoreItem] {
    return [
