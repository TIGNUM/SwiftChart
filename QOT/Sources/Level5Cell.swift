...
final class Level5Cell: UITableViewCell, Dequeueable {
    ...
    func configure(with: Level5CellViewModel?) {
        ...
        ThemeText.sprintTitle.apply((with?.level1Title ?? "").uppercased(), to: level1Title)
        ThemeText.sprintTitle.apply((with?.level2Title ?? "").uppercased(), to: level2Title)
        ThemeText.sprintTitle.apply((with?.level3Title ?? "").uppercased(), to: level3Title)
        ThemeText.sprintTitle.apply((with?.level4Title ?? "").uppercased(), to: level4Title)
        ThemeText.sprintTitle.apply((with?.level5Title ?? "").uppercased(), to: level5Title)
