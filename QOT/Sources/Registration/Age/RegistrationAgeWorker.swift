...
final class RegistrationAgeWorker: BaseSigningWorker {
    ...
    lazy var title: String = {
        return AppTextService.get(.onboarding_sign_up_age_verification_section_header_title)
    }()
    ...
    lazy var descriptionText: String = {
        return AppTextService.get(.onboarding_sign_up_age_verification_view_create_account_body_description)
    }()
