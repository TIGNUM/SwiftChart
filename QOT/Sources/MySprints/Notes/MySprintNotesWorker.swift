...
final class MySprintNotesWorker {
    ...
    lazy var title: String = {
        switch action {
        case .benefits:
            return AppTextService.get(.my_qot_my_sprints_my_sprint_details_edit_takeaways_section_header_title_header_benefits)
        case .highlights:
            return AppTextService.get(.my_qot_my_sprints_my_sprint_details_edit_takeaways_section_header_title_header_highlights)
        case .strategies:
            return AppTextService.get(.my_qot_my_sprints_my_sprint_details_edit_takeaways_section_header_title_header_strategies)
        case .captureTakeaways:
            return "-"
        }
    }()
    ...
    lazy var saveTitle: String = {
        return AppTextService.get(.my_qot_my_sprints_my_sprint_details_edit_notes_button_save)
    }()

    lazy var dismissAlertTitle: String = {
        return AppTextService.get(.my_qot_my_sprints_my_sprint_details_edit_takeaways_alert_continue_without_saving_title_leave)
    }()

    lazy var dismissAlertMessage: NSAttributedString = {
        return NSAttributedString(string: AppTextService.get(.my_qot_my_sprints_my_sprint_details_edit_takeaways_alert_continue_without_saving_body_leave))
    }()
    ...
    lazy var leaveButtonTitle: String = {
        return AppTextService.get(.my_qot_my_sprints_my_sprint_details_edit_notes_alert_button_continue)
    }()
}
