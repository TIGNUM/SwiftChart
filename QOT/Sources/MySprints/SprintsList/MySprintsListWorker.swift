...
final class MySprintsListWorker {
    ...
    lazy var title: String = {
        return AppTextService.get(.my_qot_my_sprints_null_state_title_header)
    }()

    lazy var editingTitle: String = {
        return AppTextService.get(.my_qot_my_sprints_edit_title)
    }()

    lazy var sprintPlanHeader: String = {
        return AppTextService.get(.my_qot_my_sprints_section_sprint_plan_title_sprint_plan)
    }()

    lazy var completeHeader: String = {
       return AppTextService.get(.my_qot_my_sprints_section_completed_title_completed)
    }()
    ...
    lazy var saveTitle: String = {
        return AppTextService.get(.coach_prepare_calendar_not_sync_section_footer_button_save)
    }()

    lazy var removeItemsAlertTitle: String = {
        return AppTextService.get(.my_qot_my_sprints_alert_delete_title)
    }()

    lazy var removeItemsAlertMessage: String = {
        return AppTextService.get(.my_qot_my_sprints_alert_delete_body)
    }()
    ...
    lazy var statusUpcoming: String = {
        return AppTextService.get(.my_qot_my_sprints_section_item_label_upcoming)
    }()

    lazy var statusPaused: String = {
        return AppTextService.get(.my_qot_my_sprints_section_item_label_pause)
    }()

    lazy var statusCompleted: String = {
        return AppTextService.get(.my_qot_my_sprints_section_item_label_completed)
    }()
