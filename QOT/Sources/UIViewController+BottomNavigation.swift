...
extension UIViewController {
    ...
    func cancelButtonItem(_ action: Selector) -> UIBarButtonItem {
        return roundedBarButtonItem(title: AppTextService.get(.generic_view_button_cancel),
                                    buttonWidth: .Cancel,
                                    action: action,
                                    backgroundColor: .clear,
    ...
    func continueButtonItem(_ action: Selector) -> UIBarButtonItem {
        return roundedBarButtonItem(title: AppTextService.get(.my_qot_my_plans_alert_delete_button_continue),
