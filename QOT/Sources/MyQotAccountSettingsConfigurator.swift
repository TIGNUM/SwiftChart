...
final class MyQotAccountSettingsConfigurator: AppStateAccess {
    ...
    static func configure(viewController: MyQotAccountSettingsViewController) {
        ...
        let worker = MyQotAccountSettingsWorker(userService: qot_dal.UserService.main, contentService: qot_dal.ContentService.main, networkManager: appState.networkManager)
