...
extension ArticleViewController {
    ...
    func invalidContentCell(tableView: UITableView, indexPath: IndexPath, item: Article.Item) -> ErrorCell {
        ...
        cell.configure(text: AppTextService.get(.generic_content_error_title_invalid_content), item: item)
...
extension ArticleViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .articleNextUp(let title, let description, _):
            ...
            cell.configure(header: AppTextService.get(.know_strategy_list_strategy_section_next_up_title),
                           title: title,
                           durationString: description,
                           icon: R.image.ic_seen_of())
            return cell
