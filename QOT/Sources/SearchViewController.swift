...
private extension SearchViewController {
    ...
    func setupSearchBar() {
        ...
        mySearchBar.placeholder = AppTextService.get(.coach_search_section_search_bar_placeholder_search)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case self.tableView:
            ...
            if let appLink = searchResults[indexPath.row].appLink {
                trackUserEvent(.SELECT, value: appLink.remoteID, valueType: .LINK, action: .TAP)
                appLink.launch()
            } else {
