...
enum PageName: String {
    ...
    case prepareNotesIntentionsPreceived = "prepare.notes.intentions.perceived"
    case prepareNotesIntentionsFeel = "prepare.notes.intentions.feel"
    case prepareNotesIntentionsKnow = "prepare.notes.intentions.know"
