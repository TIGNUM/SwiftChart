...
struct Search {
    ...
    enum Filter: Int {
        ...
        var title: String {
            switch self {
            case .all: return AppTextService.get(.coach_search_section_filters_label_all)
            case .read: return AppTextService.get(.coach_search_section_filters_label_read)
            case .listen: return AppTextService.get(.coach_search_section_filters_label_listen)
            case .watch: return AppTextService.get(.coach_search_section_filters_label_watch)
            case .tools: return AppTextService.get(.coach_search_section_filters_label_tools)
            }
        }
