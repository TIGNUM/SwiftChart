...
enum ButtonItem {
    ...
    var title: String {
        ...
        case .done: return AppTextService.get(AppTextKey.generic_view_title_done)
        case .save: return AppTextService.get(AppTextKey.coach_solve_results_alert_button_save)
        }
    }
