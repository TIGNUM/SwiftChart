...
final class MyDataHeatMapLegendTableViewCell: MyDataBaseTableViewCell {
    ...
    func configure() {
        ...
        ThemeText.myDataHeatMapLegendText.apply(AppTextService.get(.my_qot_my_data_section_heat_map_label_heatmap_high), to: topColorLabel)
        ThemeText.myDataHeatMapLegendText.apply(AppTextService.get(.my_qot_my_data_section_heat_map_label_heatmap_low), to: bottomColorLabel)
