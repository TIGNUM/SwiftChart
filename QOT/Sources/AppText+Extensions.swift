...
public extension AppTextKey {
    ...
    static let my_qot_my_library_media_download_view_downloading_title = AppTextKey("my_qot.my_library.media_download.view.downloading_title")
    static let my_qot_my_library_media_download_view_waiting_title = AppTextKey("my_qot.my_library.media_download.view.waiting_title")
