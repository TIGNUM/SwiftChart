...
public extension AppTextKey {
 ...
 // MARK: - Team Settings
    ...
    static let myx_team_tbv_null_state_title = AppTextKey("my_x.team_tbv.null_state.title")
    static let myx_team_tbv_null_state_subtitle = AppTextKey("my_x.team_tbv.null_state.subtitle")
