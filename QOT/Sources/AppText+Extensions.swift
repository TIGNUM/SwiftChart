...
public extension AppTextKey {
    ...
    static let my_qot_my_library_my_profile_view_my_profile_title = AppTextKey("my_qot.my_library.my_profile.view.my_profile_title")
    static let my_qot_my_library_my_library_view_my_library_title = AppTextKey("my_qot.my_library.my_library.view.my_library_title")
    static let my_qot_my_library_my_plans_view_my_plans_title = AppTextKey("my_qot.my_library.my_plans.view.my_plans_title")
    static let my_qot_my_library_my_sprints_view_my_sprints_title = AppTextKey("my_qot.my_library.my_sprints.view.my_sprints_title")
    static let my_qot_my_library_my_data_view_my_data_title = AppTextKey("my_qot.my_library.my_data.view.my_data_title")
    static let my_qot_my_library_my_tbv_view_my_tbv_title = AppTextKey("my_qot.my_library.my_tbv.view.my_tbv_title")
