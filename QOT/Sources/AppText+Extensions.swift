...
public extension AppTextKey {
    ...
    static let coach_section_mindset_subtitle = AppTextKey("coach.section_mindset.subtitle")
    static let coach_section_recovery_title = AppTextKey("coach.section_recovery.title")
    static let coach_section_recovery_subtitle = AppTextKey("coach.section_recovery.subtitle")
    ...
    static let coach_prepare_chatbot_view_body_last_step = AppTextKey("coach.prepare.chatbot.view.body_last_step")
    static let coach_tools_interactive_tool_3drecovery_chatbot_view_body_last_step = AppTextKey("coach.tools.interactive_tool.3drecovery.chatbot.view.body_last_step")
    static let coach_tools_interactive_tool_minsdset_shifter_chatbot_view_body_last_step = AppTextKey("coach.tools.interactive_tool.minsdset_shifter.chatbot.view.body_last_step")
    static let coach_search_empty_body = AppTextKey("coach.search.empty.body")
    static let coach_search_view_label_all = AppTextKey("coach.search.view.label_all")
    static let coach_search_view_label_read = AppTextKey("coach.search.view.label_read")
    static let coach_search_view_label_listen = AppTextKey("coach.search.view.label_listen")
    static let coach_search_view_label_watch = AppTextKey("coach.search.view.label_watch")
    static let coach_search_view_label_tools = AppTextKey("coach.search.view.label_tools")
    static let coach_search_section_content_title = AppTextKey("coach.search.section_content.title")
    static let coach_search_section_content_label_self_image = AppTextKey("coach.search.section_content.label_self_image")
    static let coach_search_section_content_label_daily_prep = AppTextKey("coach.search.section_content.label_daily_prep")
    static let coach_search_section_content_label_no_excuse = AppTextKey("coach.search.section_content.label_no_excuse")
    static let coach_search_section_content_label_build_capacity = AppTextKey("coach.search.section_content.label_build_capacity")
    static let coach_search_section_content_label_sleep_ritual = AppTextKey("coach.search.section_content.label_sleep_ritual")
    static let coach_search_section_content_label_power_nap = AppTextKey("coach.search.section_content.label_power_nap")
    static let coach_search_section_content_label_mindset_shifter = AppTextKey("coach.search.section_content.label_mindset_shifter")
    static let coach_search_section_content_label_reframe = AppTextKey("coach.search.section_content.label_reframe")
    static let coach_search_section_content_label_breathing = AppTextKey("coach.search.section_content.label_breathing")
    static let coach_search_section_content_label_hp_snacks = AppTextKey("coach.search.section_content.label_hp_snacks")
    static let coach_search_section_content_label_brain_performance = AppTextKey("coach.search.section_content.label_brain_performance")
    static let coach_search_section_content_label_work_to_home = AppTextKey("coach.search.section_content.label_work_to_home")
    static let coach_search_section_content_label_travel = AppTextKey("coach.search.section_content.label_travel")
    static let coach_tools_interactive_tool_minsdset_shifter_solution_section_header_title = AppTextKey("coach.tools.interactive_tool.minsdset_shifter.solution.section_header.title")
    static let coach_tools_interactive_tool_minsdset_shifter_solution_section_your_answers_title = AppTextKey("coach.tools.interactive_tool.minsdset_shifter.solution.section_your_answers.title")
    static let coach_tools_interactive_tool_minsdset_shifter_solution_section_your_answers_title_trigger = AppTextKey("coach.tools.interactive_tool.minsdset_shifter.solution.section_your_answers.title_trigger")
    static let coach_tools_interactive_tool_minsdset_shifter_solution_section_your_answers_title_reactions = AppTextKey("coach.tools.interactive_tool.minsdset_shifter.solution.section_your_answers.title_reactions")
    static let coach_tools_interactive_tool_minsdset_shifter_solution_section_your_answers_title_neg_to_pos = AppTextKey("coach.tools.interactive_tool.minsdset_shifter.solution.section_your_answers.title_neg_to_pos")
    static let coach_tools_interactive_tool_minsdset_shifter_solution_section_your_answers_title_neg_to_pos_low = AppTextKey("coach.tools.interactive_tool.minsdset_shifter.solution.section_your_answers.title_neg_to_pos_low")
    static let coach_tools_interactive_tool_minsdset_shifter_solution_section_your_answers_title_neg_to_pos_high = AppTextKey("coach.tools.interactive_tool.minsdset_shifter.solution.section_your_answers.title_neg_to_pos_high")
    static let coach_tools_interactive_tool_minsdset_shifter_solution_section_your_answers_title_vision = AppTextKey("coach.tools.interactive_tool.minsdset_shifter.solution.section_your_answers.title_vision")
    ...
    static let daily_brief_section_impact_readiness_section_5_day_rolling_title_new = AppTextKey("daily_brief.section_impact_readiness.section_5_day_rolling.title_new")
    ...
    static let daily_brief_section_my_peak_performances_title_new = AppTextKey("daily_brief.section_my_peak_performances.title_new")
    static let daily_brief_section_my_peak_performances_button_title = AppTextKey("daily_brief.section_my_peak_performances.button_title")
    static let daily_brief_section_weather_label_now = AppTextKey("daily_brief.section_weather.label_now")
    static let daily_brief_section_big_questions_title_new = AppTextKey("daily_brief.section_big_questions.title_new")
    static let daily_brief_section_whats_hot_title_new = AppTextKey("daily_brief.section_whats_hot.title_new")
    static let daily_brief_section_big_thoughts_title_new = AppTextKey("daily_brief.section_big_thoughts.title_new")
    ...
    static let daily_brief_section_daily_insights_peak_performances_null_body = AppTextKey("daily_brief.section_daily_insights.peak_performances.null_body")
    static let daily_brief_section_daily_insights_peak_performances_over_nine_body = AppTextKey("daily_brief.section_daily_insights.peak_performances.over_nine_body")
    ...
    static let daily_brief_section_explore_title_new = AppTextKey("daily_brief.section_explore.title_new")
    static let daily_brief_section_explore_body = AppTextKey("daily_brief.section_explore.body")
    static let daily_brief_section_from_my_tignum_coach_title_new = AppTextKey("daily_brief.section_from_my_tignum_coach.title_new")
    static let daily_brief_section_from_tignum_title_new = AppTextKey("daily_brief.section_from_tignum.title_new")
    static let daily_brief_section_good_to_know_title_new = AppTextKey("daily_brief.section_good_to_know.title_new")
    ...
    static let daily_brief_section_guided_track_section_step_1_title = AppTextKey("daily_brief.section_guided_track.section_step_1.title")
    static let daily_brief_section_guided_track_section_step_2_body = AppTextKey("daily_brief.section_guided_track.section_step_2.body")
    static let daily_brief_section_guided_track_section_step_2_button = AppTextKey("daily_brief.section_guided_track.section_step_2.button")
    static let daily_brief_section_guided_track_section_step_2_subtitle = AppTextKey("daily_brief.section_guided_track.section_step_2.subtitle")
    static let daily_brief_section_guided_track_section_step_2_title = AppTextKey("daily_brief.section_guided_track.section_step_2.title")
    static let daily_brief_section_guided_track_section_step_3_body = AppTextKey("daily_brief.section_guided_track.section_step_3.body")
    static let daily_brief_section_guided_track_section_step_3_button = AppTextKey("daily_brief.section_guided_track.section_step_3.button")
    static let daily_brief_section_guided_track_section_step_3_subtitle = AppTextKey("daily_brief.section_guided_track.section_step_3.subtitle")
    static let daily_brief_section_guided_track_section_step_3_title = AppTextKey("daily_brief.section_guided_track.section_step_3.title")
    static let daily_brief_section_guided_track_section_step_4_body = AppTextKey("daily_brief.section_guided_track.section_step_4.body")
    static let daily_brief_section_guided_track_section_step_4_button = AppTextKey("daily_brief.section_guided_track.section_step_4.button")
    static let daily_brief_section_guided_track_section_step_4_subtitle = AppTextKey("daily_brief.section_guided_track.section_step_4.subtitle")
    static let daily_brief_section_guided_track_section_step_4_title = AppTextKey("daily_brief.section_guided_track.section_step_4.title")
    static let daily_brief_section_guided_track_section_step_5_body = AppTextKey("daily_brief.section_guided_track.section_step_5.body")
    ...
    static let daily_brief_section_level_5_alert_body = AppTextKey("daily_brief.section_level_5.alert.body")
    static let daily_brief_section_level_5_alert_button_ok = AppTextKey("daily_brief.section_level_5.alert.button_ok")
    static let daily_brief_section_level_5_body = AppTextKey("daily_brief.section_level_5.body")
    static let daily_brief_section_level_5_button_save = AppTextKey("daily_brief.section_level_5.button_save")
    static let daily_brief_section_level_5_label_awareness = AppTextKey("daily_brief.section_level_5.label_awareness")
    static let daily_brief_section_level_5_label_knowledge = AppTextKey("daily_brief.section_level_5.label_knowledge")
    static let daily_brief_section_level_5_label_mastery = AppTextKey("daily_brief.section_level_5.label_mastery")
    static let daily_brief_section_level_5_label_readiness = AppTextKey("daily_brief.section_level_5.label_readiness")
    static let daily_brief_section_level_5_level_1_body = AppTextKey("daily_brief.section_level_5.level_1.body")
    static let daily_brief_section_level_5_level_1_title = AppTextKey("daily_brief.section_level_5.level_1.title")
    static let daily_brief_section_level_5_level_2_body = AppTextKey("daily_brief.section_level_5.level_2.body")
    static let daily_brief_section_level_5_level_2_title = AppTextKey("daily_brief.section_level_5.level_2.title")
    static let daily_brief_section_level_5_level_3_body = AppTextKey("daily_brief.section_level_5.level_3.body")
    static let daily_brief_section_level_5_level_3_title = AppTextKey("daily_brief.section_level_5.level_3.title")
    static let daily_brief_section_level_5_level_4_body = AppTextKey("daily_brief.section_level_5.level_4.body")
    static let daily_brief_section_level_5_level_4_title = AppTextKey("daily_brief.section_level_5.level_4.title")
    static let daily_brief_section_level_5_level_5_body = AppTextKey("daily_brief.section_level_5.level_5.body")
    static let daily_brief_section_level_5_level_5_title = AppTextKey("daily_brief.section_level_5.level_5.title")
    static let daily_brief_section_level_5_question = AppTextKey("daily_brief.section_level_5.question")
    static let daily_brief_section_level_5_question_with_data_one = AppTextKey("daily_brief.section_level_5.question_with_data_one")
    ...
    static let daily_brief_section_level_5_title_new = AppTextKey("daily_brief.section_level_5.title_new")
    static let daily_brief_section_my_best_card_title = AppTextKey("daily_brief.section_my_best.card_title")
    ...
    static let daily_brief_section_my_best_title_new = AppTextKey("daily_brief.section_my_best.title_new")
    ...
    static let daily_brief_section_products_we_love_title = AppTextKey("daily_brief.section_products_we_love.title")
    static let daily_brief_section_solve_reflection_body = AppTextKey("daily_brief.section_solve_reflection.body")
    static let daily_brief_section_solve_reflection_bullet_1 = AppTextKey("daily_brief.section_solve_reflection.bullet_1")
    static let daily_brief_section_solve_reflection_bullet_2 = AppTextKey("daily_brief.section_solve_reflection.bullet_2")
    ...
    static let daily_brief_section_sprint_challenge_intro_caption = AppTextKey("daily_brief.section_sprint_challenge.intro_caption")
    ...
    static let daily_brief_section_mindset_shifter_title_new = AppTextKey("daily_brief.section_mindset_shifter.title_new")
    static let daily_brief_section_mindset_shifter_cta = AppTextKey("daily_brief.section_mindset_shifter.cta")
    static let daily_brief_section_mindset_shifter_card_caption = AppTextKey("daily_brief.section_mindset_shifter_card.caption")
    ...
    static let daily_brief_team_invitation_title_new = AppTextKey("daily_brief.team_invitation.title_new")
    ...
    static let my_x_team_tbv_section_poll_button_voted = AppTextKey("my_x.team_tbv_section.poll_button_voted")
    static let my_x_team_tbv_section_poll_button_vote = AppTextKey("my_x.team_tbv_section.poll_button_vote")
    static let my_x_team_tbv_section_poll_button_options = AppTextKey("my_x.team_tbv_section.poll_button_options")
    ...
    static let myx_team_tbv_header_title_headline = AppTextKey("myx.team_tbv.header_title_headline")
    ...
    static let myx_team_tbv_null_state_cta = AppTextKey("myx.team_tbv.null_state_cta")
    ...
    static let generic_payment_screen_section_footer_title_footer = AppTextKey("generic.payment_screen.section_footer.title_footer")
    ...
    static let generic_payment_screen_expired_view_title_header_expired = AppTextKey("generic.payment_screen.expired.view.title_header_expired")
    static let generic_payment_screen_expired_view_subtitle_header_expired = AppTextKey("generic.payment_screen.expired.view.subtitle_header_expired")
    static let generic_payment_screen_view_title_prepared = AppTextKey("generic.payment_screen.view.title_prepared")
    static let generic_payment_screen_view_title_impact = AppTextKey("generic.payment_screen.view.title_impact")
    static let generic_payment_screen_view_title_grow = AppTextKey("generic.payment_screen.view.title_grow")
    static let generic_payment_screen_view_title_switch_account = AppTextKey("generic.payment_screen.view.title_switch_account")
    static let generic_payment_screen_view_subtitle_prepared = AppTextKey("generic.payment_screen.view.subtitle_prepared")
    static let generic_payment_screen_view_subtitle_impact = AppTextKey("generic.payment_screen.view.subtitle_impact")
    static let generic_payment_screen_view_subtitle_grow = AppTextKey("generic.payment_screen.view.subtitle_grow")
    static let generic_payment_screen_view_subtitle_data = AppTextKey("generic.payment_screen.view.subtitle_data")
    static let generic_payment_screen_view_subtitle_switch_account = AppTextKey("generic.payment_screen.view.subtitle_switch_account")
    ...
    static let onboarding_walkthrough_swipe_view_body = AppTextKey("onboarding.walkthrough.swipe.view.body")
    static let onboarding_log_in_faq = AppTextKey("onboarding.log_in.faq")
...
public extension AppTextKey {
    ...
    static let daily_brief_section_expert_thoughts_title = AppTextKey("daily_brief.section_expert_thoughts.title")
