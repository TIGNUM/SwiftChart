...
public extension AppTextKey {
    ...
    static let my_qot_my_tbv_alert_update_alert_title = AppTextKey("my_qot.my_tbv.alert.update_alert_title")
    static let my_qot_my_tbv_alert_update_alert_body = AppTextKey("my_qot.my_tbv.alert.update_alert_body")
    ...
    static let my_qot_my_tbv_rate_view_done_button_title = AppTextKey("my_qot.my_tbv.rate.view.done_button_title")
    static let my_qot_my_tbv_rate_view_rate_button_title = AppTextKey("my_qot.my_tbv.rate.view.rate_button_title")
    static let my_qot_my_tbv_view_done_button_title = AppTextKey("my_qot.my_tbv.view.done_button_title")
    static let my_qot_my_tbv_view_next_duration_button_title = AppTextKey("my_qot.my_tbv.view.next_duration_button_title")
    ...
    static let my_qot_my_profile_view_alert_button_title = AppTextKey("my_qot.my_profile.view.alert_button_title")
    static let my_qot_my_profile_view_alert_title = AppTextKey("my_qot.my_profile.view.alert_title")
    static let my_qot_my_profile_view_alert_body = AppTextKey("my_qot.my_profile.view.alert_body")
    static let my_qot_my_sprints_view_message_sprint_in_progress_title = AppTextKey("my_qot.my_sprints.view.message_sprint_in_progress_title")
