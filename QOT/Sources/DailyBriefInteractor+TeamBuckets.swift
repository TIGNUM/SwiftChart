...
extension DailyBriefInteractor {
    func createTeamNewsFeedViewModel(with bucket: QDMDailyBriefBucket) -> [BaseDailyBriefViewModel] {
        ...
        for teamQotId in teamQotIds {
            ...
            let header = TeamNewsFeedDailyBriefViewModel(type: .header,
                                                         team: team,
            ...
            for (index, feed) in filteredFeeds.enumerated() {
                ...
                let item = TeamNewsFeedDailyBriefViewModel(type: .storageItem,
                                                           team: team,
                                                           title: nil,
                                                           subtitle: nil,
                                                           feed: feed,
            ...
            let footer = TeamNewsFeedDailyBriefViewModel(type: .buttonAction,
                                                         team: team,
                                                         title: nil,
                                                         subtitle: nil,
                                                         feed: firstFeed,
                                                         buttonTitle: openLibraryButtonTitle,
                                                         imageURL: imageURL,
                                                         domainModel: bucket)
